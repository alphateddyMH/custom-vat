<?php
/**
 * The recurring payments integration functionality of the plugin.
 *
 * @since      2.0.0
 ...
 * The recurring payments integration functionality of the plugin.
 *
 * Handles integration with EDD Recurring Payments.
 *
 * @package    EDD_Custom_VAT
 * @subpackage EDD_Custom_VAT/integrations
 * @author     Marian Härtel <info@itmedialaw.com>
 */
class EDD_Custom_VAT_Recurring {
    ...
    public function register_late_hooks() {
        ...
        add_filter('edd_recurring_pre_record_signup_args', array($this, 'modify_recurring_signup_args'), 999, 2);
        add_filter('edd_recurring_pre_record_payment_args', array($this, 'modify_recurring_payment_args'), 999, 2);
    }
     ...
     */
    public function is_recurring($download_id) {
        if (!$this->is_recurring_active()) {
            return false;
        }
